...
from fastruct.analysis.interaction.interaction_3d import get_curve3d
...
def add_lt(
    ...
    min_desplacement = min(e1, e2)  # To place origin in bottom left corner
    coordinates = [
        (e1 - min_desplacement, 0),
        (e1 - min_desplacement + width1, 0),
        (e1 - min_desplacement + width1, height1),
        (e2 - min_desplacement + width2, height1),
        (e2 - min_desplacement + width2, height1 + height2),
        (e2 - min_desplacement, height1 + height2),
        (e2 - min_desplacement, height1),
        (e1 - min_desplacement, height1),
        (e1 - min_desplacement, 0),
    ]
